                ...
                const htmlMinTrans    form = require("./src/transforms/html-min-transform.js");
                ...
                const stripDomain = url => {
                  const strippedUrl = url.replace(process.env.GHOST_API_URL, "");
                ...
                module.exports = function(config) {
                  ...
                  config.addCollection("posts", async function(collection) {
                    ...
                    collection.forEach(post => {
                      ...
                      if (post.primary_tag) {
                        post.primary_tag.url = stripDomain(post.primary_tag.url);
                      }
                  ...
                  return {
                    ...
                    templat eFormats: ["css", "njk", "md", "txt"],
